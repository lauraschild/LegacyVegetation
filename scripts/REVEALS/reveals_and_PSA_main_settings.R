...
# RUN SETTINGS =====================================================================================
{
    ...
    {
      #picking parameters
      parameter_set = "opti"  #"opti" or "orig"
      ...
      for_southern_sites_use_params_from = "Northern Hemisphere"
        ...
        overwrite_results = T # set F for resuming computations, set T to make a fresh version of all sites to this subset folder
...
# GENERAL DEFINITONS ===============================================================================
{
    ## reveals parameter ====
    {
        run_other_as_peatland = T # Ulrike required to run all basin types (e.g. river, ocean) with REVEALS settings for peatland
        
        dwm = "gpm unstable"
        dwm_shortname = "US"
        
        peat_area = 100 # Ulrike required this. I don't know why.
        repl_val_NA_PPE = 1
...
# PATH definitions ===========================================================================================
{
    ...
    # google sheet with meta data ====
    {
        ...
        meta_df_file = file.path(input_dir, "meta_df_from_googlesheet.csv")
